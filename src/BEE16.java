/*
    ...
    O carro X sai com velocidade constante de 60 Km/h e o carro 
    Y sai com velocidade constante de 90 Km/h.
    Em uma hora (60 minutos) o carro Y consegue se 
    distanciar 30 quilômetros do carro X, ou seja, consegue 
...
public class BEE16 {
    public static void main(String[] args) {
        ...
        System.out.printf("%d minutos%n", vetor[0]*2);
        sc.close();
    }
